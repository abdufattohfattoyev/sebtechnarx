...
PHONE_DB_CONFIG = {
    'dbname': os.getenv('PHONE_DB_NAME', 'phones_db'),
    'user': os.getenv('PHONE_DB_USER', 'postgres'),
    'password': os.getenv('PHONE_DB_PASSWORD', '12345678'),
    'host': os.getenv('PHONE_DB_HOST', 'localhost'),
    'port': os.getenv('PHONE_DB_PORT', '5432')
}
